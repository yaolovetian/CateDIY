...
-(void)download{
    ...
    NSString *url=[NSString stringWithFormat:kRecommendTwoUrl,self.objid,(long)self.page];
...
- (void)creatRefreshView {
    ...
    [self.tableView addRefreshHeaderViewWithAniViewClass:[JHRefreshCommonAniView class] beginRefresh:^{
        ...
        [weakSelf addTaskUrl:[NSString stringWithFormat:kRecommendTwoUrl,weakSelf.objid,(long)weakSelf.page] isRefresh:YES];
    }];
